...
contract MerkleAirdrop is EIP712 {
    ...
    mapping(address claimer => bool claimed) public s_isClaimed;
    ...
    constructor(bytes32 _merkleRoot, IERC20 _airdropToken) EIP712("MerkleAirdrop", "1.0.0") {
        ...
        external
    {
        ...
        //@note -> double hashing done to prevent collision via second preimage attack
